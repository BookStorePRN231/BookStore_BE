        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Role_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Role_Name = table.Column<string>(type: "nvarchar(30)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category_Id = table.Column<int>(type: "int", nullable: false),
                    Book_Title = table.Column<string>(type: "nvarchar(120)", nullable: false),
                    Book_Author = table.Column<string>(type: "nvarchar(30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role_Id = table.Column<int>(type: "int", nullable: false),
                    User_Account = table.Column<string>(type: "varchar(30)", nullable: false),
                    ...
                    User_Email = table.Column<string>(type: "varchar(40)", nullable: true),
                    User_Address = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    User_Phone = table.Column<string>(type: "varchar(15)", nullable: true),
                    Is_User_Gender = table.Column<string>(type: "varchar(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Request_Book_Name = table.Column<string>(type: "nvarchar(120)", nullable: false),
                    ...
                    Request_Note = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    Is_RequestBook_Status = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is_Import_Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Inventory_Note = table.Column<string>(type: "nvarchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order_Code = table.Column<string>(type: "varchar(15)", nullable: false),
                    Order_Quantity = table.Column<int>(type: "int", nullable: false),
                    Order_Amount = table.Column<float>(type: "real", nullable: false),
                    Order_Customer_Name = table.Column<string>(type: "nvarchar(30)", nullable: false),
                    Order_Customer_Address = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    Order_Customer_Phone = table.Column<string>(type: "varchar(20)", nullable: false),
                    Is_Order_Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
