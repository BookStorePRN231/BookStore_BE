using System.Text;
using BookStoreAPI.Core.DTO.Response;
using BookStoreAPI.Core.Function;
using Newtonsoft.Json;
using Newtonsoft.Json.Serialization;
using Formatting = System.Xml.Formatting;

namespace BookStoreAPI.Core.DTO.Request;
...
public class MomoOneTimePaymentRequest
{
    ...
    public MomoOneTimePaymentRequest(string partnerCode, string requestId,
        ...
        string ipnUrl, string requestType, string extraData, string lang = "vi", string partnerName = "BookStore")
    {
